...
public class KafkaBookingListener extends com.dattp.productservice.kafkalisteners.KafkaListener {
  ...
  @org.springframework.kafka.annotation.KafkaListener(topics = KafkaTopicConfig.NEW_BOOKING_TOPIC, groupId = "com.dattp.restaurant.product.new_order", containerFactory = "factoryBooking")
